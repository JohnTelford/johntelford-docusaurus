...
It is important  a framework  abstracts [React](https://reactjs.org/) and website media  is created using [MDX](https://mdxjs.com/) with [JSX](https://reactjs.org/docs/introducing-jsx.html#Next.js-focus-wrapper). These attributes provide means to create flexable user interface, and greately decreases the time to create or port website media.
