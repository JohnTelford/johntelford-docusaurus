...
Creating and maintaining websites that meet users needs are difficult, complex, time consuming, and website live-time cost will be expensive if defects are not mitigated early.
...
The Google [PageSpeed Insights](https://pagespeed.web.dev/) website reports on the performance of a web page on both mobile and desktop devices, and provides suggestions on how pages may be improved.
